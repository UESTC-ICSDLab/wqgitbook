...
> #### important::使用 keil 进行硬件调试
> 如果你已经忘记了如何配置硬件调试环境, 可以回看[2.2.2 搭建 Keil 工程](../lab2/keilproj.md)中的内容.
...
>
> 如果是提示`SWD/JTAG Communication Failure`，说明 DAP-LINK 调试器和电脑连上了，但是 DAP-LINK 无法和 FPGA 上我们之前写的硬件部分进行通信，请检查比特流是否正确下载/固化到 FPGA开发板上，并检查硬件部分是否正确。
>
